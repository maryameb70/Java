...
public class MerchantController extends AbstractController<Merchant, MerchantDto, MerchantService> {
    ...
    @Transactional
    public void createMerchant(@Valid @RequestBody MerchantDto dto) throws ServiceException {
        service.createMerchant(converter.convertDto(dto));
    }

    @PostMapping("/qrcode")
    @Transactional
    public void createQr(@Valid @RequestBody QRCodeDto dto) throws ServiceException, IOException, WriterException {
